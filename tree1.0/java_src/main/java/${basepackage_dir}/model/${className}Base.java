...
@MappedSuperclass
public class ${className}Base implements java.io.Serializable{
...
<#macro generateNotPkProperties>
	<#list table.columns as column>
		<#if !column.pk>
	@Column(name = "${column.sqlName}", unique = ${column.unique?string}, nullable = true, insertable = true, updatable = true, length = ${column.size})
